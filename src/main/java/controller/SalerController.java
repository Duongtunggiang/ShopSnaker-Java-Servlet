...
@WebServlet("/saler-product-detail")
public class SalerController extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (product != null) {
            ...
            request.getRequestDispatcher("/saler/editProductDetail.jsp").forward(request, response);
        } else {
